...
""" Code Vaidation """
#freq = np.arange(49.3,50.2,0.01)
#freq = np.ones(3600)*50.1


""" Droop Function DE """
def FCR_D_POP(freq_in,SOC_init,battery_max_cap,max_charge, charging_max):
    #POP specific linear functions
    POP0_droop_pos_coords = [(49.5,1),(49.9,0)]
    
    POP2_droop_pos_coords = [(49.5,0.5),(49.7,0)]
                            
    POP1_droop_pos_coords = [(49.7,1),(49.9,0.5)]
    ...
    #Never allowing battery to charge/discharge beyond max. SOC
