...
""" Droop Function DE """
def FCR_DE_POP(freq_in,SOC_init,battery_max_cap,max_charge, charging_max):
    #POP specific linear functions
    POP0_droop_pos_coords = [(49.8,1),(49.99,0)]
    POP0_droop_neg_coords = [(50.01,0),(50.2,-1)]
    
    POP2_droop_pos_coords = [(49.8,0.5),(49.99,-0.5)]
    POP2_droop_neg_coords = [(50.01,-0.5),(50.1,-1)]
    
    POP1_droop_pos_coords = [(49.9,1),(49.99,0.5)]
    POP1_droop_neg_coords = [(50.01,0.5),(50.2,-0.5)]    
    ...
    SOC_max = battery_max_cap * 3600 # kWs
    ...
    for i in range(first_idx,last_idx+1):
        if POP == 0:
            ...
            if freq_in[i] <= 49.9:
                POP1_counter += 1
                idx_counter += 1
                power_ratio.append(1) #power_ratio.append(0.5)
                if i == first_idx:
                   power_kWs_app.append(power_kWs[0]+power_ratio[idx_counter-1] * charging_max *-1)
                else:
                   power_kWs_app.append(power_kWs_app[idx_counter-2] + power_ratio[idx_counter-1] * charging_max *-1)
                ...
                if power_kWs_app[idx_counter-1]/SOC_max < POP_max_threshold and power_kWs_app[idx_counter-1]/SOC_max > POP_min_threshold:
                    ...
                    if power_kWs_app[idx_counter-1] < ideal_cap_min:
                        ...
                        power_ratio[idx_counter-1] = ((power_kWs_app[idx_counter-1]-power_kWs_app[idx_counter-2])/(-1*charging_max))
                        min_counter += 1
                elif power_kWs_app[idx_counter-1]/SOC_max > ideal_cap_max:
                        power_kWs_app[idx_counter-1] = ideal_cap_max
                        power_ratio[idx_counter-1] = ((power_kWs_app[idx_counter-1]-power_kWs_app[idx_counter-2])/(-1*charging_max))
                        max_counter += 1
                SOC.append(power_kWs_app[idx_counter-1]/SOC_max)
                ...
                POP1_counter += 1
                idx_counter += 1
                power_ratio.append(0.5) #power_ratio.append(-0.5)
                if i == first_idx:
                   power_kWs_app.append(power_kWs[0]+power_ratio[idx_counter-1] * charging_max *-1)
                else:
                   power_kWs_app.append(power_kWs_app[idx_counter-2] + power_ratio[idx_counter-1] * charging_max *-1)
            ...
            elif freq_in[i] >= 50.2: #freq_in[i] >= 50.1:  
                POP1_counter += 1
                idx_counter += 1
                power_ratio.append(-0.5) #power_ratio.append(-1)
                if i == first_idx:
                   power_kWs_app.append(power_kWs[0]+power_ratio[idx_counter-1] * charging_max *-1)
                else:
                   power_kWs_app.append(power_kWs_app[idx_counter-2] + power_ratio[idx_counter-1] * charging_max *-1)
            ...
            else: #freq_in[i] > 50.01 and freq_in[i] < 50.1:
                 POP1_counter += 1
                 idx_counter += 1
            ...
            if freq_in[i] <= 49.8:
                ...
                if power_kWs_app[idx_counter-1]/SOC_max < POP_max_threshold and power_kWs_app[idx_counter-1]/SOC_max > POP_min_threshold:
                    ...
                    if power_kWs_app[idx_counter-1] > ideal_cap_max:
                        ...
                        SOC[idx_counter-1] = ideal_cap_min
                        power_ratio[idx_counter-1] = ((power_kWs_app[idx_counter-1]-power_kWs_app[idx_counter-2])/(-1*charging_max))
                        min_counter += 1
                SOC.append(power_kWs_app[idx_counter-1]/SOC_max)
