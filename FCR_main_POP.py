...
battery_max_cap = 12 #kWh ----- # Tests : 12, 24, 60 kWh
...
## calculate R^2 to estimate goodness of fit
r_squared_DK = sk.metrics.r2_score(ditch0_DOC_DK_microless,yfit_DK_microless_DOC(bins_DOC_DK_microless) )
...
r_squared_N = sk.metrics.r2_score(ditch0_DOC_N_microless,yfit_N_microless_DOC(bins_DOC_N_microless) )
