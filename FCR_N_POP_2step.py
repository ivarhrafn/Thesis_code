...
""" Droop Function DE """
def FCR_N_POP_2step(freq_in,SOC_init,battery_max_cap,max_charge, charging_max):
    #POP specific linear functions
    POP0_droop_pos_coords = [(49.9,1),(50.1,-1)]
    
    POP2_droop_pos_coords = [(49.9,0.5),(50.05,-1)]
                            
    POP1_droop_pos_coords = [(49.95,1),(50.1,-0.5)]
    
    POP4_droop_pos_coords = [(49.9,0.25),(50.025,-1)]
                            
    POP3_droop_pos_coords = [(49.975,1),(50.1,-0.25)]
    ...
    POP_min_threshold2 = POP_min2 + 0.01
    POP_max_threshold2 = POP_max2 - 0.01
    
    
    if SOC_init >= POP_max and SOC_init < POP_max2 :
        POP = 1
    elif SOC_init <= POP_min and SOC_init > POP_min2:
        POP = 2
    elif SOC_init >= POP_max2:
        POP = 3
    elif SOC_init <= POP_min2:
        POP = 4
    else:
        POP = 0
    ...
    for i in range(first_idx,last_idx+1):    
        if POP == 0:
            if freq_in[i] <= 49.9:
                ...
                if power_kWs_app[idx_counter-1]/SOC_max >= POP_max and power_kWs_app[idx_counter-1]/SOC_max < POP_max2:
                    POP = 1

                elif power_kWs_app[idx_counter-1]/SOC_max <= POP_min and power_kWs_app[idx_counter-1]/SOC_max > POP_min2:
                    POP = 2
                    
                 
                elif power_kWs_app[idx_counter-1]/SOC_max >= POP_max2:
                    POP = 3
                    if power_kWs_app[idx_counter-1] > ideal_cap_max:
                        ...
                        max_counter += 1
                elif power_kWs_app[idx_counter-1]/SOC_max <= POP_min2:
                    POP = 4
            ...
            else: #freq_in[i] > 49.9 and freq_in[i] < 50.05:
                 POP1_counter += 1
                 idx_counter += 1
            ...
            if freq_in[i] <= 49.9:
                ...
                if power_kWs_app[idx_counter-1]/SOC_max < POP_max_threshold and power_kWs_app[idx_counter-1]/SOC_max > POP_min_threshold:
                    POP = 0
                elif power_kWs_app[idx_counter-1]/SOC_max >= POP_max and power_kWs_app[idx_counter-1]/SOC_max < POP_max2:
                    POP = 1
            ...
            else:  #freq_in[i] > 49.95 and freq_in[i] < 50.1:
                 POP2_counter += 1
                 idx_counter += 1
            ...
            if freq_in[i] <= 49.975:
                 ...
                 if power_kWs_app[idx_counter-1]/SOC_max < POP_max_threshold and power_kWs_app[idx_counter-1]/SOC_max > POP_min_threshold:
                     POP = 0
                 elif power_kWs_app[idx_counter-1]/SOC_max >= POP_max and power_kWs_app[idx_counter-1]/SOC_max < POP_max_threshold2:
                     POP = 1
                 elif power_kWs_app[idx_counter-1]/SOC_max < POP_min and power_kWs_app[idx_counter-1]/SOC_max >= POP_min2:
                      POP = 2
                 elif power_kWs_app[idx_counter-1]/SOC_max <= POP_min2:
            ...
            elif freq_in[i] > 49.975 and freq_in[i] < 50.1:
                 POP4_counter += 1
                 idx_counter += 1
                 x_coords, y_coords = zip(*POP3_droop_pos_coords)
                 A = np.vstack([x_coords,np.ones(len(x_coords))]).T
                 m, c = lstsq(A, y_coords)[0]
                 power_ratio.append(m*freq_in[i] + c)
                 if i == first_idx:
            ...
            if freq_in[i] <= 49.9:
                ...
                if power_kWs_app[idx_counter-1]/SOC_max < POP_max_threshold and power_kWs_app[idx_counter-1]/SOC_max > POP_min_threshold:
                    ...
                    POP = 1
                     ...
                     if power_kWs_app[idx_counter-1] > ideal_cap_max:
                         ...
                         power_ratio[idx_counter-1] = ((power_kWs_app[idx_counter-1]-power_kWs_app[idx_counter-2])/(-1*charging_max))
                         max_counter += 1
                elif power_kWs_app[idx_counter-1]/SOC_max > POP_min_threshold2 and power_kWs_app[idx_counter-1]/SOC_max < POP_min:
                     POP = 2
                ...
                POP4_counter += 1
                idx_counter += 1
                x_coords, y_coords = zip(*POP4_droop_pos_coords)
                A = np.vstack([x_coords,np.ones(len(x_coords))]).T
                m, c = lstsq(A, y_coords)[0]
                power_ratio.append(m*freq_in[i] + c)
                if i == first_idx:
    ...
    return power_ratio , power_kWs_app,  SOC ,  POP0_counter, POP1_counter , POP2_counter, POP3_counter, POP4_counter, max_counter, min_counter
